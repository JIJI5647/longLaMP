...
def create_prompt_generator(num_retrieve = 3,  ret_type = "bm25", is_ranked = False, summarizer_technique=None, max_length = 512, tokenizer = None, output_file_paths= None):
    contriver = None
